...
cl = Ladder(input_shape=[784], n_classes=10, encoder_structure=param.convo_encoder,
    decoder_structure=param.convo_decoder, layer_importants=param.convo_layer_importants,
